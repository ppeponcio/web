...
<div class="compra-form">
    ...
    <fieldset>
        ...
        <?= $form->field($model->compra, 'cantidad')->textInput() ?>
        <?= $form->field($model->compra, 'subtotalCompra')->textInput() ?>
        <?= $form->field($model->compra, 'idUsuario')->textInput() ?>
    </fieldset>
    ...
    <fieldset>
        ...
        echo '<th>' . $ticket->getAttributeLabel('idPresentacion') . '</th>';
        echo '<td>&nbsp;</td>';
        echo '</tr>';
        echo '</thead>';
        echo '<tbody>';
